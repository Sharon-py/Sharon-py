...
<img src="https://capsule-render.vercel.app/api?type=soft&color=0:FADADD,45:D7C0F2,100:B8E0D2&height=120&section=header&text=Hi,%20I'm%20Sharon%20%F0%9F%91%BE&fontSize=28&fontColor=3B2F4A&fontAlignY=45&animation=fadeIn&font=Press%20Start%202P"/>
...
I'm a Data Scientist with a background in mathematics, statistics and machine learning.  
I enjoy building projects that are useful, clean and easy to understand — from data exploration to modeling and interpretation.
...
|---|---|---|
| [Predict schizophrenia using brain anatomy](https://github.com/Sharon-py/Predict-schizophrenia-using-brain-anatomy) | Machine learning project using brain anatomy data to explore prediction and model evaluation. | Python, Jupyter, ML |
| [TrioVision](https://github.com/Sharon-py/TrioVision) | Computer vision / data science project. | Jupyter Notebook |
| NLP & RAG experiments | Text processing, information extraction and LLM-based pipeline experiments. | Python, NLP, LLM |
...
| Project | Description | Tools |
|---|---|---|
| [RFM Segmentation](https://github.com/Sharon-py/Segmentation_RFM) | Customer segmentation project based on recency, frequency and monetary value. | SAS, analytics |
| [Time Series Project](https://github.com/Sharon-py/MOSEF---Projet-Time-Series) | Time series analysis project from my statistics and finance background. | Statistics, HTML |

---

### 🧪 Research-style data projects
...
<details>
<summary>Open profile note 👾</summary>

<br>

I like projects that mix technical depth with concrete applications.  
My favorite kind of work is when I can start from messy data, understand the problem, build a model, evaluate it properly, and explain the results clearly.

I’m especially drawn to projects where data science can support useful, practical and understandable decisions.
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:FADADD,45:D7C0F2,100:B8E0D2&height=100&section=footer"/>
